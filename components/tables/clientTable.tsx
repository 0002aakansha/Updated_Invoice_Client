            ...
            <table className="table-auto w-full shadow-md xs:table-fixed md:table-auto  rounded-t-lg">
              <thead>
                <tr className="bg-[#5a51be] text-stone-50">
                  <th className="py-3 px-4 font-semibold uppercase  md:w-[10%] xs:text-xs  sm:text-xs md:text-base">
                    S. No.
                  </th>
              ...
              <tbody>
                {clients?.clients?.map((client, i) => (
                  ...
                  >
                    <td className="text-center md:py-3 font-semibold xs:text-xs sm:text-xs md:text-base sm:pr-0 sm:pl-0">
                      {i + 1}.
                    </td>
