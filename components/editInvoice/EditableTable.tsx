...
//       amount: project.projectDetails?.amount
//         ? project.projectDetails?.amount
//         : "0,0.0",
//       rate: project.rate || project.projectDetails.rate,
//       conversionRate: project.conversionRate
//         ? project.projectDetails?.conversionRate
//         : "N/A",
//       projectBelongsTo:
...
//   }, [dispatch, invoice?.createdFor?._id]);
...
//   useEffect(() => {
//       setProjectRow(
//         invoice.projects?.map((project: any, indx: number) =>
...
//       )
//     );
//   }, [invoice?.invoiceType, invoice?.projects, projectRow, projects]);
